...
\begin{figure}[t]
\centering
\includegraphics[width=0.92\textwidth]{standalone_architecture.pdf}
...
\begin{equation}
\mathcal{D}^{\mathrm{sym}}=\tfrac12\big(D_{\mathrm{KL}}(q_v\|q_t)+D_{\mathrm{KL}}(q_t\|q_v)\big),\quad
...
\label{eq:nce}
\end{equation}
and the total loss is $\mathcal{L}=\tfrac12(\mathcal{L}_{i2t}+\mathcal{L}_{t2i})+\mathcal{L}_{\mathrm{KL}}$. The KL term is present only when AVSC is switched on. Algorithm~\ref{alg:train} gives one training step.

\begin{algorithm}[t]
\caption{One training step (Mamba-2 + HEDO, optional AVSC)}
\label{alg:train}
\begin{algorithmic}[1]
\State Sample 8 images and their 40 captions; extract frozen features $\mathbf{X}_v,\mathbf{X}_t$
\State $\mathbf{H}\gets\mathrm{HEDO}(\mathbf{X}\mathbf{W})$ for each stream \Comment{Eqs.~\eqref{eq:JR}--\eqref{eq:hedoout}}
\State $\mathbf{Y}\gets\mathrm{Mamba2}(\mathbf{H})$; $\mathbf{z}\gets\mathrm{normalize}(\mathrm{Pool}(\mathbf{Y}))$
\State $\mathcal{L}\gets\tfrac12(\mathcal{L}_{i2t}+\mathcal{L}_{t2i})$ \Comment{Eq.~\eqref{eq:nce}}
\If{AVSC enabled} $\mathcal{L}\gets\mathcal{L}+\mathcal{L}_{\mathrm{KL}}$ \EndIf
\State Backpropagate, clip $\|\mathbf{g}\|_2\le1$, AdamW step ($\eta=10^{-4}$, wd $10^{-4}$)
\end{algorithmic}
\end{algorithm}
...
\textbf{Statistics.} For each configuration $c$ and seed $s\in\{42,43,44\}$ we compute the paired difference $\Delta_{c,s}=\mathrm{MR}_{c,s}-\mathrm{MR}_{\mathrm{base},s}$ and form the interval $\bar\Delta_c\pm t_{0.025,2}\,s_c/\sqrt3$, where $t_{0.025,2}=4.303$. We decided on the reading rule in advance. An interval entirely above zero counts as \emph{supported}, one that contains zero means \emph{no statistical difference}, and one entirely below zero counts as \emph{contradicted}. We report seven comparisons without multiplicity correction and say so openly.

\textbf{Controls.} Every forward and backward pass checks that all tensors are finite, and each run confirms that the official Mamba-2 CUDA kernels were loaded. We recorded a SHA-256 hash of the methodology (\texttt{1753cfb7\ldots1af54}) so that the setup can be traced later.
...
\begin{table}[t]
\centering
\caption{Retrieval on the Flickr8k test set (mean $\pm$ SD over 3 seeds).}
\label{tab:main}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lccccccccc}
\toprule
Configuration & i2t R@1 & i2t R@5 & i2t R@10 & t2i R@1 & t2i R@5 & t2i R@10 & MR (\%) & i2t MedR & t2i MedR\\
\midrule
Baseline & $16.53\pm0.70$ & $43.27\pm0.72$ & $57.47\pm1.14$ & $13.92\pm0.45$ & $38.31\pm0.38$ & $53.45\pm0.49$ & $37.16\pm0.57$ & $7.67$ & $9.00$\\
Mamba-2 + HEDO & $\mathbf{17.40\pm0.62}$ & $\mathbf{43.47\pm1.85}$ & $57.20\pm1.10$ & $\mathbf{14.20\pm0.58}$ & $38.25\pm0.47$ & $53.35\pm0.50$ & $\mathbf{37.31\pm0.68}$ & $7.67$ & $9.00$\\
\midrule
Mamba-2 + MSA & $9.77\pm0.51$ & $29.53\pm0.95$ & $42.90\pm1.04$ & $8.92\pm0.47$ & $28.22\pm0.59$ & $41.98\pm0.75$ & $26.89\pm0.68$ & $13.83$ & $14.67$\\
HEDO + MSA & $9.47\pm0.47$ & $29.50\pm1.47$ & $42.87\pm1.59$ & $8.33\pm0.42$ & $27.45\pm0.09$ & $40.84\pm0.84$ & $26.41\pm0.49$ & $14.67$ & $15.33$\\
\midrule
AVSC + MSA & $1.47\pm0.32$ & $6.40\pm1.87$ & $11.50\pm1.84$ & $1.50\pm0.26$ & $6.51\pm0.28$ & $12.48\pm0.76$ & $6.64\pm0.82$ & $81.67$ & $61.33$\\
Mamba-2 + AVSC & $1.80\pm0.78$ & $6.27\pm1.10$ & $11.87\pm0.96$ & $1.05\pm0.32$ & $5.55\pm1.38$ & $10.19\pm2.74$ & $6.12\pm1.14$ & $99.83$ & $72.33$\\
Full model & $1.47\pm0.31$ & $5.97\pm0.47$ & $10.73\pm0.68$ & $1.25\pm0.29$ & $5.60\pm0.69$ & $10.69\pm1.09$ & $5.95\pm0.42$ & $94.33$ & $69.67$\\
HEDO + AVSC & $1.03\pm0.12$ & $4.93\pm0.90$ & $9.27\pm1.05$ & $1.01\pm0.23$ & $4.83\pm1.15$ & $9.20\pm1.89$ & $5.04\pm0.84$ & $103.17$ & $79.00$\\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{fig_factorial_recall.pdf}
...
\begin{tabular}{lcccc}
\toprule
Comparison & Per-seed $\Delta$ (42/43/44) & Mean $\Delta$ (pp) & 95\% CI (pp) & Verdict\\
\midrule
Mamba-2 + HEDO & $-0.27/-0.15/+0.88$ & $+0.15$ & $[-1.42,+1.73]$ & No diff.\\
Mamba-2 + MSA & $-11.26/-9.02/-10.53$ & $-10.27$ & $[-13.10,-7.44]$ & Contradicted\\
HEDO + MSA & $-11.12/-9.99/-11.14$ & $-10.75$ & $[-12.38,-9.12]$ & Contradicted\\
AVSC + MSA & $-31.01/-30.94/-29.60$ & $-30.52$ & $[-32.49,-28.54]$ & Contradicted\\
Mamba-2 + AVSC & $-32.98/-29.83/-30.30$ & $-31.04$ & $[-35.26,-26.81]$ & Contradicted\\
Full model & $-31.55/-30.56/-31.51$ & $-31.21$ & $[-32.60,-29.81]$ & Contradicted\\
HEDO + AVSC & $-33.71/-31.05/-31.58$ & $-32.11$ & $[-35.61,-28.62]$ & Contradicted\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.62\textwidth]{fig_paired_deltas.pdf}
\caption{Paired differences in Mean Recall with 95\% Student-$t$ intervals. Only Mamba-2 + HEDO overlaps zero.}
\label{fig:delta}
\end{figure}

Fig.~\ref{fig:delta} shows the same numbers as a forest plot. The seed-to-seed spread is small (SD $\le0.68$ pp for the two leading models). However, three seeds give limited power, so the one interval that includes zero should not be taken as proof that the two models are equivalent.
...
\toprule
Configuration & Trainable params & Peak VRAM (MB) & Train time (s) & Head lat.\ (ms) & Head p/s & E2E p/s\\
\midrule
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{fig_efficiency_tradeoff.pdf}
