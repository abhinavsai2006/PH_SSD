...
\end{equation}
Under the evaluated formulation, these competing optimization pressures are consistent with the observed severe representation degradation.
\end{theorem}
