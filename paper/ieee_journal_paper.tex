...
The overall architecture of HEDO-HVSC is depicted in Fig.~\ref{fig:architecture}. An input image $\mathbf{I} \in \mathbb{R}^{3 \times 224 \times 224}$ and caption text $\mathbf{T}$ are processed through frozen pretrained backbones to extract spatial and textual sequence representations:
\begin{align}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.92\textwidth]{figures/fig1_benchmark_results.pdf}
    \caption{Schematic of the HEDO-HVSC pipeline. Frozen ViT-B/16 and RoBERTa features are transformed by HEDO coordinate-momentum dissipation, processed by state-continuous chunk-wise SSD recurrence, aggregated via mask-weighted boundary states, and regularized by symmetric KL divergence in training.}
...
\midrule
SSD Baseline & ❌ & ❌ & $26.53 \pm 0.33$ & $57.30 \pm 0.80$ & $20.45 \pm 0.56$ & $49.89 \pm 0.19$ & $48.25 \pm 0.47$ \\
HEDO-HVSC w/o HEDO & ❌ & ✅ & $26.70 \pm 0.82$ & $57.07 \pm 0.85$ & $20.29 \pm 0.36$ & $49.95 \pm 0.21$ & $48.22 \pm 0.43$ \\
HEDO-HVSC w/o HVSC & ✅ & ❌ & $\mathbf{27.20 \pm 0.99}$ & $56.97 \pm 0.19$ & $20.66 \pm 0.53$ & $\mathbf{50.33 \pm 0.22}$ & $\mathbf{48.43 \pm 0.29}$ \\
\textbf{Full HEDO-HVSC (Ours)} & ✅ & ✅ & $26.73 \pm 1.87$ & $\mathbf{56.83 \pm 0.47}$ & $\mathbf{20.71 \pm 0.18}$ & $49.97 \pm 0.40$ & $\mathbf{48.28 \pm 0.59}$ \\
\bottomrule
\end{tabular}
\end{table*}
